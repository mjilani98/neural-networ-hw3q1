...
public class NeuralNetwork 
{
    ...
    public void train()
    {
    	...
    	for(int i = 0  ; i < numberIterations ; i++)
    	{
    		...
    		{
    			//calculate input/output - forward pass
  ...
  //Method performs forward pass - computes input/output
    ...
    {
    	System.out.println("middle nodes : "+numberMiddle+" iterations : "+numberIterations+"\n");
         ...
         for (int i = 0; i < numberRecords; i++)
         {
           ...
           //display actual outputs
             for (int j = 0; j < numberOutputs; j++)
                 System.out.print(actualOutput[j] + " Actual");
             System.out.println();

             //display predicted outputs
             for (int j = 0; j < numberOutputs; j++)
                 System.out.print(predictedOutput[j] + " predicted");
             System.out.println();
             System.out.println();
         }
    ...
    public void print()
    {
    	...
    	{
    		inputs = records.get(x).input;
    		outputs = records.get(x).output;
